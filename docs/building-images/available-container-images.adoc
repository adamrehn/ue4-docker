...
You can build the following images using the xref:../commands/ue4-docker-build.adoc[ue4-docker build] command:
...
* Use this image for xref:../use-cases/continuous-integration.adoc[CI pipelines] that do not require ue4cli, conan-ue4cli, or ue4-ci-helpers.
...
* xref:../use-cases/continuous-integration.adoc[CI pipelines] that require ue4cli, conan-ue4cli, or ue4-ci-helpers
...
* Packaging xref:../use-cases/microservices.adoc[UE4-powered microservices]
