...
elseif ($visual_studio_build -eq "18")
{
    if ($unreal_engine_version.StartsWith("5.8"))
    {
        $windows_sdk_version = 22621
        $windows_os_version = "Windows11SDK"
        $vs_tools_version = "14.50.18.0"
    }
}
else
{
    ...
    elseif ($unreal_engine_version.StartsWith("5.7") -or $unreal_engine_version.StartsWith("5.8"))
    {
        $windows_sdk_version = 22621
        $windows_os_version = "Windows11SDK"
        $vs_tools_version = "14.44.17.14"
    }
}
